(function(){
  ...
  stage.innerHTML=`
    ...
    <p class="city-footnote">City architecture and atmosphere express the model; they do not add simulation rules. Portals change your view. Resident transit remains an explicit gate action.</p>`;
  shell.prepend(stage);
