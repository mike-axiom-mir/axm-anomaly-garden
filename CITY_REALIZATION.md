...
Rendered review now passes on this revision through the supported managed preview. The earlier failure came from reloading a stale browser error page; a fresh tab at the documented preview address restored access. Desktop review covered outer and nested worlds, running ticks, city/code modes, resident and event cameras, glitch injection and reduced motion. It found and repaired the co-located portal label pile-up by fanning the real portal stack horizontally and using compact depth labels in city mode.

The same application was inspected inside a 390 × 844 phone viewport. Body width and scroll width both measured 375px; there was no page overflow. Nested-world selection, Run, clock advancement and real change pulses remained legible. The legend's internal horizontal scrollbar was removed after inspection. Filtered browser logs contained no application errors. Mean Canvas draw work measured 1.32ms across 120 samples; cloud callback p95 was about 1033ms, so sustained FPS remains unproven.
